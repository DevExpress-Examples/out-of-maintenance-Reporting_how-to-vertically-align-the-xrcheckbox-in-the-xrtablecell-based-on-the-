...
Namespace RepAlignCheckBoxTableCell
	Partial Public Class XtraReport1
		...
		Private Function ConvertFromReportUnitToPixels(ByVal value As Single) As Integer
            Dim unit As GraphicsUnit = CType(IIf(Me.ReportUnit = ReportUnit.HundredthsOfAnInch, GraphicsUnit.Inch, GraphicsUnit.Millimeter), GraphicsUnit)
            Dim multiplier As Single = Convert.ToSingle(IIf(unit = GraphicsUnit.Inch, 100, 10))
